...
/** mutation root */
export type Mutation_RootGetTokenArgs = {
  arg: Credentials
}
...
export type GetAllQuestionQuery = {
  Questions: Array<
    Pick<Questions, 'Id' | 'Libelle' | 'IsPublie'> & {
      QuestionAnswer: Pick<QuestionAnswers, 'Libelle'>
      QuestionCategory: Pick<QuestionCategories, 'Libelle'>
      QuestionPropositions: Array<Pick<QuestionPropositions, 'Libelle'>>
    }
  >
}
...
export type GetQuestionbyIdQuery = {
  Questions_by_pk?: Maybe<
    Pick<Questions, 'Id' | 'Libelle' | 'IsPublie' | 'QuestionCategorieId'> & {
      QuestionAnswer: Pick<QuestionAnswers, 'Id' | 'Libelle'>
      QuestionPropositions: Array<Pick<QuestionPropositions, 'Id' | 'Libelle'>>
    }
  >
}

export type GetQuestionCategoriesQueryVariables = Exact<{
  [key: string]: never
}>

export type GetQuestionCategoriesQuery = {
  QuestionCategories: Array<Pick<QuestionCategories, 'Id' | 'Libelle'>>
}

export type InsertQuestionMutationVariables = Exact<{
  Question: Questions_Insert_Input
}>
...
export type InsertQuestionCategorieMutationVariables = Exact<{
  QuestionCategorie: QuestionCategories_Insert_Input
}>

export type InsertQuestionCategorieMutation = {
  insert_QuestionCategories_one?: Maybe<Pick<QuestionCategories, 'Id'>>
}

export type UpdateQuestionMutationVariables = Exact<{
  Id: Scalars['Int']
  Libelle?: Maybe<Scalars['String']>
  IsPublie: Scalars['Boolean']
  QuestionCategorieId: Scalars['Int']
  QuestionAnswer: QuestionAnswers_Insert_Input
  QuestionPropositions:
    | Array<QuestionPropositions_Insert_Input>
...
export function useGetAllQuestionQuery(
  options: Omit<Urql.UseQueryArgs<GetAllQuestionQueryVariables>, 'query'> = {},
) {
  return Urql.useQuery<GetAllQuestionQuery>({
    query: GetAllQuestionDocument,
    ...options,
  })
}
...
export function useGetQuestionbyIdQuery(
  options: Omit<Urql.UseQueryArgs<GetQuestionbyIdQueryVariables>, 'query'> = {},
) {
  return Urql.useQuery<GetQuestionbyIdQuery>({
    query: GetQuestionbyIdDocument,
    ...options,
  })
}
export const GetQuestionCategoriesDocument = gql`
...
export function useGetQuestionCategoriesQuery(
  options: Omit<
    Urql.UseQueryArgs<GetQuestionCategoriesQueryVariables>,
    'query'
  > = {},
) {
  return Urql.useQuery<GetQuestionCategoriesQuery>({
    query: GetQuestionCategoriesDocument,
    ...options,
  })
}
...
export const InsertQuestionCategorieDocument = gql`
...
export function useInsertQuestionCategorieMutation() {
  return Urql.useMutation<
    InsertQuestionCategorieMutation,
    InsertQuestionCategorieMutationVariables
  >(InsertQuestionCategorieDocument)
}
